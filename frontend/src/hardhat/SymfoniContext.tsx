...
import { Calculator__factory } from "./typechain/factories/Calculator__factory";
...
export const CalculatorContext = React.createContext<SymfoniCalculator>(emptyContract);
...
export interface SymfoniCalculator {
    instance?: Calculator;
    factory?: Calculator__factory;
}
...
export const Symfoni: React.FC<SymfoniProps> = ({
    ...
    const [Calculator, setCalculator] = useState<SymfoniCalculator>(emptyContract);
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        const doAsync = async () => {
            ...
            const finishWithContracts = (text: string) => {
                setCalculator(getCalculator(_provider, _signer))
                finish(text)
            }
    ...
    const getCalculator = (_provider: providers.Provider, _signer?: Signer) => {

        const contractAddress = "0x5FbDB2315678afecb367f032d93F642f64180aa3"
        const instance = _signer ? Calculator__factory.connect(contractAddress, _signer) : Calculator__factory.connect(contractAddress, _provider)
        const contract: SymfoniCalculator = {
            instance: instance,
            factory: _signer ? new Calculator__factory(_signer) : undefined,
        }
        return contract
    }
        ;
